    ...
    return (
        <section className={styles.container}>
            <div className={styles.content}>
                ...
                <p className={styles.discription}>I have 4 years of experience as a full-stack developer, working with React and Java. I'm very passionate and dedicated to my work</p>
